...
def update_restaurant(restaurant_id: int, restaurant_update: RestaurantUpdate, db: Session = Depends(get_db), current_user = Depends(get_current_user)):
    db_restaurant = restaurant_crud.get_restaurant(db, restaurant_id)
...
def delete_restaurant(restaurant_id: int, db: Session = Depends(get_db), current_user = Depends(get_current_user)):
    db_restaurant = restaurant_crud.get_restaurant(db, restaurant_id)
